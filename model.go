// Package model defines the database models and data structures used by the Spider Panel.
package model
...
type Client struct {
	...
	ExternalProxy string      `json:"externalProxy,omitempty"`     // External proxy hostname (e.g., cdn.example.com)
	ExternalPort  int         `json:"externalPort,omitempty"`      // External proxy port
}
